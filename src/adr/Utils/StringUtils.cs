...
namespace adr.Utils
{
    ...
    public static class StringUtils
    {
        ...
        /// <remarks>simple adaption from Lucene ASCIIFoldingFilter - https://github.com/apache/lucenenet/blob/master/src/Lucene.Net.Analysis.Common/Analysis/Miscellaneous/ASCIIFoldingFilter.cs </remarks>
        public static string FoldToASCII(string text)
        {
            /*
             * simple adaption from Lucene ASCIIFoldingFilter
            ...
            */
            ...
            foreach (var c in text)
            {
                ...
                {
                    string substitution = c.ToString();
